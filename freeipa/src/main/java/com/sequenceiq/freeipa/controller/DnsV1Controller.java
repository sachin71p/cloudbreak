...
public class DnsV1Controller implements DnsV1Endpoint {
    ...
    @Override
    @CheckPermissionByResourceCrn(action = EDIT_ENVIRONMENT)
    public void deleteDnsARecord(@ResourceCrn @NotEmpty String environmentCrn, @NotEmpty String dnsZone, @NotEmpty String hostname) {
        String accountId = crnService.getCurrentAccountId();
        try {
    ...
    @Override
    @CheckPermissionByResourceCrn(action = EDIT_ENVIRONMENT)
    public void deleteDnsCnameRecord(@ResourceCrn @NotEmpty String environmentCrn, @NotEmpty String dnsZone, @NotEmpty String cname) {
        String accountId = crnService.getCurrentAccountId();
        try {
