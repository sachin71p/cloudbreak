...
class AwsDownscaleServiceTest {
    ...
    void downscaleASG() {
        ...
        verify(cfStackUtil, times(0)).removeLoadBalancerTargets(any(), any(), any(), any(), any());
    ...
    void downscaleWithLoadBalancers() {
        ...
        doNothing().when(cfStackUtil).removeLoadBalancerTargets(any(), any(), any(), any(), any());
        ...
        verify(cfStackUtil, times(2)).removeLoadBalancerTargets(any(), any(), any(), any(), any());
    }
