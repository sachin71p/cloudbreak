...
public class AwsUpscaleService {
    ...
    private void sendASGUpdateFailedMessage(AmazonAutoScalingRetryClient amazonASClient, Map<String, Group> desiredAutoscalingGroupsByName, AmazonAutoscalingFailed amazonAutoscalingFailed) {
