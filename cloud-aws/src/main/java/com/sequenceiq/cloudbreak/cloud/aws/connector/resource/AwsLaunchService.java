...
public class AwsLaunchService {
    ...
    private void updateCloudformationWithLoadBalancers(AuthenticatedContext ac, CloudStack stack, PersistenceNotifier resourceNotifier,
        ...
        if (!cloudLoadBalancers.isEmpty()) {
            ...
            for (CloudLoadBalancer cloudLoadBalancer : cloudLoadBalancers) {
                awsLoadBalancers.add(convert(cloudLoadBalancer, instances, awsNetworkView, amazonEC2Client));
            }
    ...
    private AwsLoadBalancer convert(CloudLoadBalancer cloudLoadBalancer, List<CloudResource> instances,
